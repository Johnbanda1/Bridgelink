...
const About: React.FC<AboutProps> = ({ language }) => {
  const content = {
    en: {
      ...
      history: 'Bridgelink Minerals Consultants Ltd is a proudly African BEE company with over 10 years of experience in delivering high-quality mining services. From humble beginnings, our growth has been driven by hard work, innovation, and customer satisfaction. We provide tailored, value-added solutions that support both short- and long-term client needs, with expertise, equipment, and skilled professionals available 24/7. Accredited and aligned with international quality standards, we are committed to efficiency, continuous improvement, and timely results, with a strong focus on serving the coal mining industry.',
      mission: {
        title: 'Our Mission',
